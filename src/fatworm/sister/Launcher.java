...
public class Launcher {
	...
	public static final boolean useMySQL = false;
	public static final String forClass = "fatworm.driver.Driver"; 
	public static final String forMySQLClass = "com.mysql.jdbc.Driver";
	
	private static String url = "jdbc:fatworm:/" + System.getProperty("user.dir") + File.separator + "db";
