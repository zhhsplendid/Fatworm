...
public class SqlClient {
	...
	static {
		try {
			if(Launcher.useMySQL){
				Class.forName(Launcher.forMySQLClass);
			}
			else{
				Class.forName(Launcher.forClass);
			}
	...
	public void connect(String url) {
		try {
			if(Launcher.useMySQL){
				conn = DriverManager.getConnection(Launcher.MySQLurl, Launcher.usr, Launcher.password);
			}
			else{
